...
class SimpleScannerActivity : AppCompatActivity(), ZBarScannerView.ResultHandler, MessageDialogListener {
    ...
    override fun handleResult(rawResult: Result) { // Scan results
    ...
    fun showMessageDialog(message: String?) {
        val fragment: DialogFragment = MessageDialogFragment.newInstance("Resultados", message, this)
        fragment.show(supportFragmentManager, "")
    }

    override fun onDialogPositiveClick(dialog: DialogFragment) { // Toast.makeText(this, "Código a usar => " + code, Toast.LENGTH_SHORT).show();
        val data = Intent()
    ...
    override fun onDialogNeutralClick(dialog: DialogFragment) { // Resume the camera
