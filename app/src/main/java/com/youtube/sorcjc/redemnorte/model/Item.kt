...
class Item(// Codes
        @field:SerializedName("QR_code") var qr: String, @field:SerializedName("patrimonial_code") var patrimonial: String, // General
        @field:SerializedName("denominacion") var description: String) {
    // Parent (header)
